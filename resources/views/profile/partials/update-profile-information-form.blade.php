<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Lengkapkan semua maklumat profil dan muat naik avatar untuk mengakses fungsi sistem.') }}
        </p>
    </header>
        ...
        <div>
            ...
            @if ($user->avatar_path)
                <img
                    ...
                    class="mt-2 h-20 w-20 rounded-full object-cover ring-1 ring-gray-200"
                >
            @endif
